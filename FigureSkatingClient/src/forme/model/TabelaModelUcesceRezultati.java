 ...
 * @author pc acer
 */
public class TabelaModelUcesceRezultati extends AbstractTableModel {

    ArrayList<Ucesce> ucesca;
    String[] header = new String[]{"Klizač", "Disciplina", "Tehnički deo", "Prezentacija"};

    public TabelaModelUcesceRezultati() {
        ucesca = new ArrayList<>();
    }

    public TabelaModelUcesceRezultati(ArrayList<Ucesce> ucesca) {
        this.ucesca = ucesca;
    }
